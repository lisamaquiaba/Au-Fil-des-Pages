<div class="footer">
      ...
      <div class="link">
        ...
        <a href="bibliotheque.php"><p>Bibliothèque</p></a>
        <a href="club.php"><p>Club de Lecture</p></a>
        <a href="contact.php"><p>Nous Contacter</p></a>
      </div>
      <div class="social">
        <h3>Rejoignez-nous sur :</h3>
        <a href="https://www.tiktok.com/"
          ><img src="./assets/images/tiktok.png" alt="Logo TikTok"
        /></a>
        <a href="https://www.instagram.com/"
          ><img src="./assets/images/instagram.png" alt="Logo Instagram"
        /></a>
        <a href="https://www.youtube.com/"
          ><img src="./assets/images/youtube.png" alt="Logo Youtube"
        /></a>
      </div>
      <div class="copyright">
        <img src="./assets/images/copyright.png" alt="" width="15" height="15" />
